import { encodeSqrtRatioX96, Pool } from '@monoswap-labs/v3-sdk'
...
} from '@monoswap-labs/smart-order-router/build/main/index'
import { V3PoolAccessor } from '@monoswap-labs/smart-order-router/build/main/providers/v3/pool-provider'
